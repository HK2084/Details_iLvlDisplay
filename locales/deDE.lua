...
L["TOOLTIP_COLOR"]              = "Färbt die iLvl-Zahl danach, wie weit jemand in der aktuellen Season ausgerüstet ist. Gold liegt über allem, was Mythisch+ hergibt, darunter Orange, Lila, Blau, Grün, Grau. Die Grenzen stammen aus den Mythisch+-Belohnungsstufen dieser Season und wandern damit mit, statt zu veralten."
...
L["WN_158_ILVLCOLOUR_D"]        = "Die Grenzen stammen aus den Mythisch+-Belohnungsstufen dieser Season statt aus festen Zahlen und wandern damit mit. Gold ist neu und liegt über allem, was Mythisch+ hergibt."
