...
function page.Init(parent)
    ...
    local panel = W.CreatePanel(parent, parent:GetWidth(), 300, "UI Layer Errors")
    ...
    local body = W.CreateLabel(panel, text, theme.FONT_LABEL, "primary",
        panel:GetWidth() - 40)
    ...
    local hint = W.CreateLabel(panel,
        ...
        theme.FONT_HELPER, "secondary", panel:GetWidth() - 40)
